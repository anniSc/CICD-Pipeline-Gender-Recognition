...
radon raw data/dataprep_scripts/datapreparation.py > radon_tests/radon_raw_datapreparation.txt
radon raw test/model_test_scripts/model_test.py > radon_tests/radon_raw_model_test.txt 