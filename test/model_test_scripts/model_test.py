...
class Main_Model_Test(ModelTester, TestFairness,ModelExplainability):
    ...
    def run_tests():
        ...
        ModelTester.test_noise_robustness(model, test_dataloader, device,end_noise=1.0, step = 0.1)
        ModelTester.test_distortion_robustness(model, test_dataloader, device, end_distortion=0.05, step = 0.0001)
